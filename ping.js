...
//Added mouse controls -Seokyoung

document.getElementById("up-button").addEventListener("mousedown", function() {controls.upPressed= true;});
document.getElementById("up-button").addEventListener("mouseup", function() {controls.upPressed= false;});
document.getElementById("down-button").addEventListener("mousedown", function() {controls.downPressed= true;});
document.getElementById("down-button").addEventListener("mouseup", function() {controls.downPressed= false;});